...
to the `University VPN <https://heriotwatt.sharepoint.com/sites/is-servicecatalogue/SitePages/Virtual-Private-Network-(VPN).aspx>`_ , or request access to the SSH gateway via the self-service portal first.
